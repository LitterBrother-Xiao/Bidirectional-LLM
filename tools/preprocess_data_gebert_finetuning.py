...
class Encoder(object):
    ...
    def encode(self, json_line):
        ...
        source_text = data[Encoder.input_column]
        target_text = data[Encoder.target_column]
...
def get_args():
    ...
    group.add_argument('--input-column', type=str, default='source')
    group.add_argument('--target-column', type=str, default='target')
