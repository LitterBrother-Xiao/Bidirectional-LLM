...
if __name__ == "__main__":
    ...
    parser.add_argument('--golden-file', dest="golden_file", help='Input data file, one golden per line.', default="xxx.tgt")
    parser.add_argument('--pred-file', dest="pred_file", help='Model predictions.', default="xxx.out")
